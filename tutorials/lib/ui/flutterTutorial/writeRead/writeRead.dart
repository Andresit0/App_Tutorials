...
class WriteRead extends StatefulWidget {
  WriteRead({Key? key}) : super(key: key);
  @override
  WriteReadPageState createState() => WriteReadPageState();
}

class WriteReadPageState extends State<WriteRead> {
  @override
