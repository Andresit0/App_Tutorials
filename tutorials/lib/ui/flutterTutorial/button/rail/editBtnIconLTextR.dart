...
TextEditingController btnIconPaddingIconText = TextEditingController();
StreamController<MaterialColor> btnIconStreamPaddingIconText =
    StreamController.broadcast();
...
Widget editBtnIconLTextR(BuildContext context) {
  return Container(
