...
class Streamcontroller extends StatefulWidget {
  Streamcontroller({Key? key}) : super(key: key);
  @override
  StreamcontrollerPageState createState() => StreamcontrollerPageState();
}

class StreamcontrollerPageState extends State<Streamcontroller> {
  @override
