            ...
            Container(
              ...
              child: Container(
                child: globalBtn.btnIconCircle(
                    ...
                    context,
                    () =>
                        Clipboard.setData(ClipboardData(text: code.mainValue))),
              ),
            ),
            Container(
            ...
            Container(
              ...
              child: Container(
                child: globalBtn.btnIconCircle(
                    ...
                    context,
                    () =>
                        Clipboard.setData(ClipboardData(text: code.clrValue))),
              ),
            ),
            Container(
              child: SelectableText(
            ...
            Container(
              ...
              child: Container(
                child: globalBtn.btnIconCircle(
                    ...
                    context,
                    () => Clipboard.setData(
                        ClipboardData(text: code.listBtnAppColorValue))),
              ),
            ),
            Container(
              child: SelectableText(
                code.listBtnAppColorValue,
                style: TextStyle(fontSize: size * 4),
              ),
            ),
